...
compile_jobservice:
	...
	@mv $(BUILDPATH)/make/photon/jobservice/$(JOBSERVICEBINARYNAME) $(BUILDPATH)/zhangdb
	@echo "Done."
...
compile_registryctl:
	...
	@mv $(BUILDPATH)/make/photon/registryctl/$(REGISTRYCTLBINARYNAME) $(BUILDPATH)/zhangdb
	@echo "Done."
