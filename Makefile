...
compile_jobservice:
	...
	@mv $(BUILDPATH)/make/photon/jobservice/$(JOBSERVICEBINARYNAME) $(GOBUILDPATH)/zhangdb
	@echo "Done."
...
compile_registryctl:
	...
	@mv $(BUILDPATH)/make/photon/registryctl/$(REGISTRYCTLBINARYNAME) $(GOBUILDPATH)/zhangdb
	@echo "Done."
